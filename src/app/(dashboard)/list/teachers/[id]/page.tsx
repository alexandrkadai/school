    ...
    <div className="flex flex-1 flex-col gap-4 p-4 xl:flex-row">
      ...
      <div className="w-full xl:w-2/3">
        <div className="flex flex-col gap-4 lg:flex-row">
          {/* user info Card */}
          <div className="flex flex-1 gap-4 rounded-xl bg-sky px-4 py-6">
            <div className="w-1/3">
              <Image
            ...
            <div className="flex w-2/3 flex-col justify-between gap-4">
              ...
              <p className="text-sm text-gray-500">
                I`m teacher and teacher must love his work beacause teaching
                kids is the future of an America
              </p>
        ...
        {/* Bottom */}
        <div className="mt-4 h-[750px] rounded-md bg-white p-4">
          <h1>SCHEDULE</h1>
          <BigCalendar />
        </div>
      </div>
      ...
      <div className="flex w-full flex-col gap-4 xl:w-1/3">
        <div className="rounded-xl bg-white p-4">
          ...
          <div className="mt-4 flex flex-wrap gap-4 text-xs text-gray-500">
            <Link className="rounded-md bg-yellow-200 p-3" href="/">
              Teacher&apos;s Classes
            </Link>
            <Link className="rounded-md bg-purl p-3" href="/">
              Teacher&apos;s Students
            </Link>
            <Link className="rounded-md bg-pink-50 p-3" href="/">
              Teacher&apos;s Exams
            </Link>
            <Link className="rounded-md bg-low p-3" href="/">
              Teacher&apos;s Lessons
            </Link>
